import { Actor, BoxBody, CircleBody, Destination, Enemy, FilledBox, Goodie, Hero, ImageSprite, JetLagGameConfig, KeyCodes, ManualMovement, Obstacle, Path, PathMovement, Scene, TextSprite, initializeAndLaunch, stage } from "../jetlag";
...
function builder(level: number) {
  ...
  new Actor({
    ...
    rigidBody: new BoxBody({ cx: 11.6, cy: 0.05, width: .1, height: .1 }, { scene: stage.hud }),
  });
