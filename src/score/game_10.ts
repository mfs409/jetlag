import { Actor, BoxBody, CircleBody, Destination, FilledBox, Hero, ImageSprite, JetLagGameConfig, Scene, TextSprite, TiltMovement, initializeAndLaunch, stage } from "../jetlag";
