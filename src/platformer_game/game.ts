import { Actor, ActorPoolSystem, AnimatedSprite, AnimationSequence, AnimationState, BoxBody, CircleBody, DIRECTION, Enemy, FilledBox, FilledCircle, Goodie, Hero, ImageSprite, JetLagGameConfig, KeyCodes, ManualMovement, Obstacle, Path, PathMovement, PolygonBody, Projectile, ProjectileMovement, Scene, TextSprite, initializeAndLaunch, stage } from "../jetlag";
...
/**
 * Draw a box without a top
 *
 * Note: the box is actually three narrow rectangles
 *
